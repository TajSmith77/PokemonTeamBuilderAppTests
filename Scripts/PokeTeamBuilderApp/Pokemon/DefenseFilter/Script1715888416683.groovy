...
WebUI.setText(findTestObject('PokemonTeamBuilderApp/Page_Pokedex/input_Min DEFENSE_min_defense'), '80')
...
WebUI.click(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_Pokedex/li_82  magneton  electric, steel'))

WebUI.verifyElementText(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_magneton Details/h1_82 magneton'), 
    '82 magneton')

WebUI.verifyElementText(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_magneton Details/li_Defense 95'), 'Defense: 95')
