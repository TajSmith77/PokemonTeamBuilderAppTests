...
WebUI.click(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_KataTestTeam Details/button_Delete'))

WebUI.acceptAlert()

WebUI.verifyElementText(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_Teams/li_You have no teams'), 'You have no teams')
