...
WebUI.setText(findTestObject('PokemonTeamBuilderApp/Page_Pokedex/input_Pokedex_pokedex_number'), '587')

WebUI.click(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_Pokedex/button_Apply Filters'))

WebUI.click(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_Pokedex/li_587  emolga  electric, flying'))

WebUI.verifyElementText(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_emolga Details/h1_587 emolga'), '587 emolga')
