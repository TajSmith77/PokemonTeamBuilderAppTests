...
WebUI.click(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_Community/li_ArachnoGang       By NotSpiderman'))

WebUI.click(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_ArachnoGang Details/button_Back to community'))
