...
WebUI.setText(findTestObject('PokemonTeamBuilderApp/Page_Pokedex/input_Name_poke_name'), 'pikachu')

WebUI.click(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_Pokedex/button_Apply Filters'))

WebUI.click(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_Pokedex/li_25  pikachu  electric'))

WebUI.verifyElementText(findTestObject('Object Repository/PokemonTeamBuilderApp/Page_pikachu Details/h1_25 pikachu'), '25 pikachu')
